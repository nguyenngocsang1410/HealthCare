...
import com.fanny.healthcare.draw.SpO2SurfaceView;

import java.util.ArrayList;
import java.util.List;

public class ZNSBActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_znsb3);
...
//				}
                ...
                break;
                case MSG_PROBE_OFF:{
                    Toast.makeText(ZNSBActivity3.this, "probe off", Toast.LENGTH_SHORT).show();
                }
                break;
                default:break;
            }
    ...
    public final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                Toast.makeText(ZNSBActivity3.this, "connected success", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(ZNSBActivity3.this, "Disconnected", Toast.LENGTH_SHORT).show();
