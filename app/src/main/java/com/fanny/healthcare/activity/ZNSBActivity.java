...
import com.fanny.healthcare.blebooth.BLEManager;
import com.fanny.healthcare.blebooth.BluetoothLeService;
import com.fanny.healthcare.blebooth.ReaderBLE;
import com.fanny.healthcare.blebooth.SenderBLE;
...
public class ZNSBActivity extends AppCompatActivity {


    private static final String TAG = "ZNSBActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_znsb);
...
//                        mDrawSPO2Rect.clean();
                ...
                break;
                case MSG_PROBE_OFF:{
                    Toast.makeText(ZNSBActivity.this, "probe off", Toast.LENGTH_SHORT).show();
                }
                break;
                default:break;
            }
    ...
    class FingerOximeterCallBack implements IFingerOximeterCallBack {
        ...
        public void OnGetSpO2Param(int nSpO2, int nPR, float fPI, boolean nStatus, int nMode, float nPower,int powerLevel) {
            ...
            myHandler.obtainMessage(2, "数据--" + nSpO2 + " " + nPR + " " + fPI).sendToTarget();
        }
    ...
    public final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                Toast.makeText(ZNSBActivity.this, "connected success", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(ZNSBActivity.this, "Disconnected", Toast.LENGTH_SHORT).show();
...
//	}
            ...
            while (bDrawWave) {
                if (!bProbeOff && !bPause ) {
                    while (SPO_WAVE.size()>0) {
                        BaseDate.Wave temp = SPO_WAVE.remove(0);
     ...
     * @param context
     */
    private void android6_RequestLocation(final ZNSBActivity context){
